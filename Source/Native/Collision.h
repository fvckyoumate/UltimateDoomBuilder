...
public:
	FVector3() = default;
	FVector3(float v) : X(v), Y(v), Z(v) { }
	FVector3(const FVector2& v, float z) : X(v.X), Y(v.Y), Z(z) { }
...
public:
	...
	FVector4(const FVector3& v, float w) : X(v.X), Y(v.Y), Z(v.Z), W(w) { }
	FVector4(float x, float y, float z, float w) : X(x), Y(y), Z(z), W(w) { }

	float X, Y, Z, W;
};

inline FVector3 operator+(const FVector3& a, const FVector3& b) { return FVector3(a.X + b.X, a.Y + b.Y, a.Z + b.Z); }
inline FVector3 operator-(const FVector3& a, const FVector3& b) { return FVector3(a.X - b.X, a.Y - b.Y, a.Z - b.Z); }
inline FVector3 operator*(const FVector3& a, const FVector3& b) { return FVector3(a.X * b.X, a.Y * b.Y, a.Z * b.Z); }
inline FVector3 operator/(const FVector3& a, const FVector3& b) { return FVector3(a.X / b.X, a.Y / b.Y, a.Z / b.Z); }
inline FVector3 operator*(const FVector3& a, float b) { return FVector3(a.X * b, a.Y * b, a.Z * b); }
inline FVector3 operator/(const FVector3& a, float b) { return FVector3(a.X / b, a.Y / b, a.Z / b); }

// dot product
inline float operator|(const FVector3& a, const FVector3& b) { return a.X * b.X + a.Y * b.Y + a.Z * b.Z; }
inline float operator|(const FVector4& a, const FVector4& b) { return a.X * b.X + a.Y * b.Y + a.Z * b.Z + a.W * b.W; }

// cross product
inline FVector3 operator^(const FVector3& a, const FVector3& b) { return FVector3(a.Y * b.Z - a.Z * b.Y, a.Z * b.X - a.X * b.Z, a.X * b.Y - a.Y * b.X); }
